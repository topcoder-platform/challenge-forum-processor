...
module.exports = {
  ...
  ROCKETCHAT: {
    ...
    PORT: Number(process.env.ROCKETCHAT_PORT || "3001"),
  ...
  VANILLA: {
    ...
    ADMIN_ACCESS_TOKEN: process.env.VANILLA_ADMIN_ACCESS_TOKEN || "va.HPJuxDDFu1iBNOwUktOiibXmkT0Qowoy.Sa2wdg.1MzoHpV",
  },
  TOPCODER: {
